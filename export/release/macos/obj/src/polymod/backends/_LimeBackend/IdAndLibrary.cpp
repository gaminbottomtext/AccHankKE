...
HX_DEFINE_STACK_FRAME(_hx_pos_04fa384cfca16a40_572_new,"polymod.backends._LimeBackend.IdAndLibrary","new",0x62fe42a8,"polymod.backends._LimeBackend.IdAndLibrary.new","polymod/backends/LimeBackend.hx",572,0xcff7dfd6)
namespace polymod{
namespace backends{
...
void IdAndLibrary_obj::__construct(::String id, ::haxe::ds::StringMap libs, ::polymod::backends::LimeModLibrary l){
            	HX_STACKFRAME(&_hx_pos_04fa384cfca16a40_572_new)
HXLINE( 573)		this->fallbackId = id;
HXLINE( 574)		int colonIndex = id.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 575)		this->lib = id.substring(0,colonIndex);
HXLINE( 576)		this->nakedId = id.substring((colonIndex + 1),null());
HXLINE( 577)		if (::hx::IsNotNull( l )) {
HXLINE( 578)			this->library = l;
            		}
            		else {
HXLINE( 579)			if (::hx::IsNotNull( libs )) {
HXLINE( 580)				bool _hx_tmp;
HXDLIN( 580)				if ((this->lib != HX_("",00,00,00,00))) {
HXLINE( 580)					_hx_tmp = ::hx::IsNull( this->lib );
            				}
            				else {
HXLINE( 580)					_hx_tmp = true;
            				}
HXDLIN( 580)				if (_hx_tmp) {
HXLINE( 581)					this->lib = HX_("default",c1,d8,c3,9b);
            				}
HXLINE( 583)				this->library = ( ( ::polymod::backends::LimeModLibrary)(libs->get(this->lib)) );
            			}
            		}
HXLINE( 585)		bool _hx_tmp;
HXDLIN( 585)		bool _hx_tmp1;
HXDLIN( 585)		if (::hx::IsNotNull( this->library )) {
HXLINE( 585)			_hx_tmp1 = ::hx::IsNotNull( this->library->pathPrefix );
            		}
            		else {
HXLINE( 585)			_hx_tmp1 = false;
            		}
HXDLIN( 585)		if (_hx_tmp1) {
HXLINE( 585)			_hx_tmp = (this->library->pathPrefix != HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 585)			_hx_tmp = false;
            		}
HXDLIN( 585)		if (_hx_tmp) {
HXLINE( 586)			this->modId = ((this->library->pathPrefix + HX_("/",2f,00,00,00)) + this->nakedId);
            		}
HXLINE( 588)		this->modId = this->nakedId;
            	}
