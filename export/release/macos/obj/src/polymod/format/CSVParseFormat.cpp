...
HXDLIN( 220)				 ::Dynamic msg = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE( 272)				buf->b = ::Array_obj< ::String >::fromData( _hx_array_data_2d231aa3_16,1);
            			}
            			else {
...
HXLINE( 287)								buf->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(cell));
            							}
            							else {
HXLINE( 287)								::Array< ::String > buf1 = buf->b;
HXDLIN( 287)								buf1->push(::Std_obj::string(cell));
            							}
            						}
HXLINE( 288)						if (this->quotedCells) {
HXLINE( 290)							if ((dq >= 127)) {
HXLINE( 290)								::String x = ::String::fromCharCode(dq);
HXDLIN( 290)								if (::hx::IsNotNull( buf->charBuf )) {
HXLINE( 290)									buf->flush();
            								}
HXDLIN( 290)								if (::hx::IsNull( buf->b )) {
HXLINE( 290)									buf->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x));
            								}
            								else {
HXLINE( 290)									::Array< ::String > buf1 = buf->b;
HXDLIN( 290)									buf1->push(::Std_obj::string(x));
            								}
            							}
            							else {
HXLINE( 290)								if (::hx::IsNull( buf->charBuf )) {
HXLINE( 290)									buf->charBuf = ::Array_obj< char >::__new();
            								}
HXDLIN( 290)								buf->charBuf->push(dq);
            							}
            						}
HXLINE( 292)						if ((ix != (row->length - 1))) {
HXLINE( 294)							::String x = this->delimeter;
HXDLIN( 294)							if (::hx::IsNotNull( buf->charBuf )) {
HXLINE( 294)								buf->flush();
            							}
HXDLIN( 294)							if (::hx::IsNull( buf->b )) {
HXLINE( 294)								buf->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x));
            							}
            							else {
HXLINE( 294)								::Array< ::String > buf1 = buf->b;
HXDLIN( 294)								buf1->push(::Std_obj::string(x));
            							}
            						}
            					}
            				}
HXLINE( 297)				if ((iy != (grid->length - 1))) {
HXLINE( 299)					if (::hx::IsNotNull( buf->charBuf )) {
HXLINE( 299)						buf->flush();
            					}
HXDLIN( 299)					if (::hx::IsNull( buf->b )) {
HXLINE( 299)						buf->b = ::Array_obj< ::String >::fromData( _hx_array_data_2d231aa3_17,1);
            					}
            					else {
HXLINE( 299)						buf->b->push(HX_("\r\n",5d,0b,00,00));
            					}
            				}
            			}
            		}
HXLINE( 303)		return buf->toString();
            	}
