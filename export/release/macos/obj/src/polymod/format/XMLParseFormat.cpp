...
HX_DEFINE_STACK_FRAME(_hx_pos_be220568d9d5b1fe_480_new,"polymod.format.XMLParseFormat","new",0x075e5a24,"polymod.format.XMLParseFormat.new","polymod/format/ParseRules.hx",480,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_be220568d9d5b1fe_499_parse,"polymod.format.XMLParseFormat","parse",0x836912f7,"polymod.format.XMLParseFormat.parse","polymod/format/ParseRules.hx",499,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_be220568d9d5b1fe_504_append,"polymod.format.XMLParseFormat","append",0x1ad2ca96,"polymod.format.XMLParseFormat.append","polymod/format/ParseRules.hx",504,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_be220568d9d5b1fe_515_merge,"polymod.format.XMLParseFormat","merge",0xcbda257c,"polymod.format.XMLParseFormat.merge","polymod/format/ParseRules.hx",515,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_be220568d9d5b1fe_543_print,"polymod.format.XMLParseFormat","print",0x8e9edaf1,"polymod.format.XMLParseFormat.print","polymod/format/ParseRules.hx",543,0xc5c5c43b)
namespace polymod{
namespace format{
...
void XMLParseFormat_obj::__construct(::hx::Null< bool >  __o_prettyPrint,::Array< ::String > headers,::Array< ::String > footers){
            	...
            	HX_STACKFRAME(&_hx_pos_be220568d9d5b1fe_480_new)
HXLINE( 483)		this->prettyPrint = false;
HXLINE( 489)		if (::hx::IsNull( headers )) {
HXLINE( 489)			headers = ::Array_obj< ::String >::__new(0);
            		}
HXLINE( 490)		if (::hx::IsNull( footers )) {
HXLINE( 490)			footers = ::Array_obj< ::String >::__new(0);
            		}
HXLINE( 491)		this->stripHeaders = headers;
HXLINE( 492)		this->stripFooters = footers;
HXLINE( 493)		this->prettyPrint = prettyPrint;
HXLINE( 494)		this->format = ::polymod::format::TextFileFormat_obj::XML_dyn();
            	}
...
void *XMLParseFormat_obj::_hx_getInterface(int inHash) {
 ...
 ::Xml XMLParseFormat_obj::parse(::String str){
            	HX_STACKFRAME(&_hx_pos_be220568d9d5b1fe_499_parse)
HXDLIN( 499)		return ::Xml_obj::parse(str);
            	}
...
::String XMLParseFormat_obj::append(::String baseText,::String appendText,::String id){
            	HX_STACKFRAME(&_hx_pos_be220568d9d5b1fe_504_append)
HXDLIN( 504)		bool _hx_tmp;
HXDLIN( 504)		if (::hx::IsNotNull( this->stripHeaders )) {
HXDLIN( 504)			_hx_tmp = ::hx::IsNotNull( this->stripFooters );
            		}
            		else {
HXDLIN( 504)			_hx_tmp = false;
            		}
HXDLIN( 504)		if (_hx_tmp) {
HXLINE( 506)			return ::polymod::util::Util_obj::appendSpecialXML(baseText,appendText,this->stripHeaders,this->stripFooters);
            		}
            		else {
HXLINE( 510)			return ::polymod::util::Util_obj::appendXML(baseText,appendText);
            		}
...
::String XMLParseFormat_obj::merge(::String baseText,::String mergeText,::String id){
            	HX_STACKFRAME(&_hx_pos_be220568d9d5b1fe_515_merge)
HXLINE( 516)		 ::Xml basex = null();
HXLINE( 517)		 ::Xml mergex = null();
HXLINE( 519)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 521)			basex = ::Xml_obj::parse(baseText);
HXLINE( 522)			mergex = ::Xml_obj::parse(mergeText);
            		} catch( ::Dynamic _hx_e) {
...
HXDLIN( 524)				 ::Dynamic msg = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 526)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((((HX_("Error parsing XML files during merge (",5b,0b,12,8a) + id) + HX_(") ",d7,23,00,00)) + ::Std_obj::string(msg))));
            			}
            			else {
...
HXLINE( 529)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 531)			::polymod::format::XMLMerge_obj::mergeXMLNodes(basex,mergex);
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
...
HXDLIN( 533)				 ::Dynamic msg = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 535)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((((HX_("Error combining XML files during merge (",8f,b2,77,22) + id) + HX_(") ",d7,23,00,00)) + ::Std_obj::string(msg))));
            			}
            			else {
            				HX_STACK_DO_THROW(_hx_e);
            			}
            		}
HXLINE( 538)		return this->print(basex);
            	}
...
::String XMLParseFormat_obj::print( ::Xml xml){
            	HX_STACKFRAME(&_hx_pos_be220568d9d5b1fe_543_print)
HXDLIN( 543)		return ::haxe::xml::Printer_obj::print(xml,this->prettyPrint);
            	}
