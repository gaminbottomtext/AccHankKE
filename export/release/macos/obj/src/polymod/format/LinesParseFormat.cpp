...
HX_DEFINE_STACK_FRAME(_hx_pos_da011ef85b625651_405_new,"polymod.format.LinesParseFormat","new",0xde5818bc,"polymod.format.LinesParseFormat.new","polymod/format/ParseRules.hx",405,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_da011ef85b625651_411_parse,"polymod.format.LinesParseFormat","parse",0x5b41a78f,"polymod.format.LinesParseFormat.parse","polymod/format/ParseRules.hx",411,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_da011ef85b625651_436_append,"polymod.format.LinesParseFormat","append",0x207c3afe,"polymod.format.LinesParseFormat.append","polymod/format/ParseRules.hx",436,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_da011ef85b625651_440_merge,"polymod.format.LinesParseFormat","merge",0xa3b2ba14,"polymod.format.LinesParseFormat.merge","polymod/format/ParseRules.hx",440,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_da011ef85b625651_465_print,"polymod.format.LinesParseFormat","print",0x66776f89,"polymod.format.LinesParseFormat.print","polymod/format/ParseRules.hx",465,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_da011ef85b625651_470_getEndl,"polymod.format.LinesParseFormat","getEndl",0x183eb243,"polymod.format.LinesParseFormat.getEndl","polymod/format/ParseRules.hx",470,0xc5c5c43b)
namespace polymod{
namespace format{

void LinesParseFormat_obj::__construct( ::polymod::format::EndLineType endline){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_405_new)
HXLINE( 406)		this->format = ::polymod::format::TextFileFormat_obj::LINES_dyn();
HXLINE( 407)		this->endline = endline;
            	}
...
::Array< ::String > LinesParseFormat_obj::parse(::String str){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_411_parse)
HXLINE( 412)		bool _hx_tmp;
HXDLIN( 412)		if (::hx::IsNotNull( str )) {
HXLINE( 412)			_hx_tmp = (str == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 412)			_hx_tmp = true;
            		}
HXDLIN( 412)		if (_hx_tmp) {
HXLINE( 412)			return ::Array_obj< ::String >::__new(0);
            		}
HXLINE( 413)		::String other = HX_("",00,00,00,00);
HXLINE( 414)		::String endl = HX_("",00,00,00,00);
HXLINE( 415)		switch((int)(this->endline->_hx_getIndex())){
            			case (int)0: {
HXLINE( 417)				endl = HX_("\n",0a,00,00,00);
            			}
            			break;
            			case (int)1: {
HXLINE( 418)				endl = HX_("\r",0d,00,00,00);
            			}
            			break;
            			case (int)2: {
HXLINE( 419)				endl = HX_("\r\n",5d,0b,00,00);
            			...
            			break;
            			default:{
HXLINE( 420)				endl = HX_("\r",0d,00,00,00);
HXDLIN( 420)				other = HX_("\n",0a,00,00,00);
            			}
            		}
HXLINE( 422)		if ((other == HX_("",00,00,00,00))) {
HXLINE( 424)			return str.split(endl);
            		}
            		else {
HXLINE( 428)			str = ::StringTools_obj::replace(str,other,endl);
HXLINE( 429)			return str.split(endl);
            		}
...
::String LinesParseFormat_obj::append(::String baseText,::String appendText,::String id){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_436_append)
HXDLIN( 436)		return ::polymod::util::Util_obj::uCombine(::Array_obj< ::String >::__new(3)->init(0,baseText)->init(1,this->getEndl())->init(2,appendText));
            	}
...
::String LinesParseFormat_obj::merge(::String baseText,::String mergeText,::String id){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_440_merge)
HXLINE( 441)		bool _hx_tmp;
HXDLIN( 441)		if (::hx::IsNotNull( baseText )) {
HXLINE( 441)			_hx_tmp = (mergeText == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 441)			_hx_tmp = true;
            		}
HXDLIN( 441)		if (_hx_tmp) {
HXLINE( 441)			return baseText;
            		}
HXLINE( 442)		bool _hx_tmp1;
HXDLIN( 442)		if (::hx::IsNotNull( baseText )) {
HXLINE( 442)			_hx_tmp1 = (mergeText == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 442)			_hx_tmp1 = true;
            		}
HXDLIN( 442)		if (_hx_tmp1) {
HXLINE( 442)			return baseText;
            		}
HXLINE( 443)		::Array< ::String > lines = this->parse(baseText);
HXLINE( 444)		bool _hx_tmp2;
HXDLIN( 444)		if (::hx::IsNotNull( lines )) {
HXLINE( 444)			_hx_tmp2 = (lines->length <= 0);
            		}
            		else {
HXLINE( 444)			_hx_tmp2 = true;
            		}
HXDLIN( 444)		if (_hx_tmp2) {
HXLINE( 444)			return baseText;
            		}
HXLINE( 445)		::Array< ::String > mergeLines = this->parse(mergeText);
HXLINE( 446)		bool _hx_tmp3;
HXDLIN( 446)		if (::hx::IsNotNull( mergeLines )) {
HXLINE( 446)			_hx_tmp3 = (mergeLines->length <= 1);
            		}
            		else {
HXLINE( 446)			_hx_tmp3 = true;
            		}
HXDLIN( 446)		if (_hx_tmp3) {
HXLINE( 446)			return baseText;
            		}
HXLINE( 447)		::String pattern = ( (::String)(mergeLines->shift()) );
HXLINE( 448)		::Array< ::String > newLines = ::Array_obj< ::String >::__new(0);
HXLINE( 449)		{
HXLINE( 449)			int _g = 0;
HXDLIN( 449)			while((_g < lines->length)){
HXLINE( 449)				::String line = lines->__get(_g);
HXDLIN( 449)				_g = (_g + 1);
HXLINE( 451)				if ((line.indexOf(pattern,null()) == 0)) {
HXLINE( 453)					newLines = newLines->concat(mergeLines);
            				}
            				else {
HXLINE( 457)					newLines->push(line);
            				}
            			}
            		}
HXLINE( 460)		return ::polymod::util::Util_obj::uJoin(newLines,this->getEndl());
            	}
...
::String LinesParseFormat_obj::print(::Array< ::String > lines){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_465_print)
HXDLIN( 465)		return lines->join(this->getEndl());
            	}
...
::String LinesParseFormat_obj::getEndl(){
            	HX_STACKFRAME(&_hx_pos_da011ef85b625651_470_getEndl)
HXDLIN( 470)		switch((int)(this->endline->_hx_getIndex())){
            			case (int)0: {
HXLINE( 472)				return HX_("\n",0a,00,00,00);
            			}
            			break;
            			case (int)1: {
HXLINE( 473)				return HX_("\r",0d,00,00,00);
            			}
            			break;
            			case (int)2: {
HXLINE( 474)				return HX_("\r\n",5d,0b,00,00);
            			}
            			break;
            			default:{
HXLINE( 475)				return HX_("\n",0a,00,00,00);
            			}
            		}
