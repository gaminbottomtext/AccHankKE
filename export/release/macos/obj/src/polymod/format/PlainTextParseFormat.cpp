...
HX_LOCAL_STACK_FRAME(_hx_pos_19ba14b2e25efefe_946_parse,"polymod.format.PlainTextParseFormat","parse",0xefd79e37,"polymod.format.PlainTextParseFormat.parse","polymod/format/ParseRules.hx",946,0xc5c5c43b)
...
HX_LOCAL_STACK_FRAME(_hx_pos_19ba14b2e25efefe_981_print,"polymod.format.PlainTextParseFormat","print",0xfb0d6631,"polymod.format.PlainTextParseFormat.print","polymod/format/ParseRules.hx",981,0xc5c5c43b)
namespace polymod{
namespace format{
...
::String PlainTextParseFormat_obj::parse(::String str){
            	HX_STACKFRAME(&_hx_pos_19ba14b2e25efefe_946_parse)
HXDLIN( 946)		return str;
            	}
...
::String PlainTextParseFormat_obj::print(::String str){
            	HX_STACKFRAME(&_hx_pos_19ba14b2e25efefe_981_print)
HXDLIN( 981)		return str;
            	}
