...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_614_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",614,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_675_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",675,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_706_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",706,0xf073a2d5)
...
HXLINE( 109)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("hank",76,2b,08,45)) ){
HXLINE( 504)			::String library = null();
HXDLIN( 504)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/hank",3b,6e,bb,94)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 504)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/hank",3b,6e,bb,94)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 505)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Hank Idle",fe,cb,ca,43),24,false,null(),null());
HXLINE( 506)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("Hank Up note",2d,a1,c7,8f),24,false,null(),null());
HXLINE( 507)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("Hank Down Note",66,03,a7,1a),24,false,null(),null());
HXLINE( 508)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("Hank Left Note",a1,1d,71,19),24,false,null(),null());
HXLINE( 509)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("Hank right note",00,cb,6b,5f),24,false,null(),null());
HXLINE( 511)			this->animation->addByPrefix(HX_("shootDown",e1,81,1e,60),HX_("Hank Down Shoot",eb,9b,d8,13),24,false,null(),null());
HXLINE( 512)			this->animation->addByPrefix(HX_("shootLeft",86,91,60,65),HX_("Hank Left Shoot",50,75,e5,05),24,false,null(),null());
HXLINE( 513)			this->animation->addByPrefix(HX_("shootUp",1a,42,73,76),HX_("Hank Up shoot",44,0c,42,1b),24,false,null(),null());
HXLINE( 514)			this->animation->addByPrefix(HX_("shootRight",7d,d1,2b,c6),HX_("Hank right shoot",11,7b,42,fb),24,false,null(),null());
HXLINE( 516)			this->animation->addByPrefix(HX_("scaredIdle",54,db,25,4c),HX_("HankScaredIdle",8a,ce,bd,8e),24,false,null(),null());
HXLINE( 517)			this->animation->addByPrefix(HX_("scaredShootTiky",a2,b7,95,ec),HX_("HankScaredShootsTiky",2d,26,0b,55),24,false,null(),null());
HXLINE( 518)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 519)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 520)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 521)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 522)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 524)			this->addOffset(HX_("shootDown",e1,81,1e,60),null(),null());
HXLINE( 525)			this->addOffset(HX_("shootLeft",86,91,60,65),null(),null());
HXLINE( 526)			this->addOffset(HX_("shootUp",1a,42,73,76),null(),null());
HXLINE( 527)			this->addOffset(HX_("shootRight",7d,d1,2b,c6),null(),null());
HXLINE( 529)			this->addOffset(HX_("scaredIdle",54,db,25,4c),null(),null());
HXLINE( 530)			this->addOffset(HX_("scaredShootTiky",a2,b7,95,ec),0,247);
HXLINE( 532)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 503)			goto _hx_goto_0;
            		}
...
HXLINE( 142)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("tiky",63,ca,fc,4c)) ){
HXLINE( 535)			::String library = null();
HXDLIN( 535)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/tiky",28,0d,b0,9c)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 535)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/tiky",28,0d,b0,9c)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 536)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("trickyidle",9a,42,1c,55),24,false,null(),null());
HXLINE( 537)			this->animation->addByPrefix(HX_("singDown",51,8e,c5,36),HX_("trickydwon",f8,9e,dc,51),24,false,null(),null());
HXLINE( 538)			this->animation->addByPrefix(HX_("singLeft",f6,9d,07,3c),HX_("trickyileft",aa,6a,e2,28),24,false,null(),null());
HXLINE( 539)			this->animation->addByPrefix(HX_("singRight",0d,a7,af,c1),HX_("trickyright",96,85,83,55),24,false,null(),null());
HXLINE( 540)			this->animation->addByPrefix(HX_("singUp",8a,52,21,b9),HX_("trickyup",61,f4,a4,b2),24,false,null(),null());
...
HXLINE( 591)				::haxe::Log_obj::trace(HX_("dance",33,83,83,d4),::hx::SourceInfo(HX_("source/Character.hx",c9,4f,91,f5),591,HX_("Character",89,bb,a4,e3),HX_("update",09,86,05,87)));
HXLINE( 592)				this->dance();
HXLINE( 593)				this->holdTimer = ( (Float)(0) );
            			}
            		}
HXLINE( 597)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 600)			bool _hx_tmp;
HXDLIN( 600)			if ((this->animation->_curAnim->name == HX_("hairFall",bd,48,d6,cb))) {
HXLINE( 600)				_hx_tmp = this->animation->_curAnim->finished;
            			}
            			else {
...
HXLINE( 604)		this->super::update(elapsed);
            	}


void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_614_dance)
HXDLIN( 614)		if (!(this->debugMode)) {
HXLINE( 616)			::String _hx_switch_0 = this->curCharacter;
            			if (  (_hx_switch_0==HX_("gf",1f,5a,00,00)) ){
...
HXLINE( 641)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-christmas",94,26,b1,6d)) ){
HXLINE( 630)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 632)					this->danced = !(this->danced);
HXLINE( 634)					if (this->danced) {
HXLINE( 635)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 637)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 630)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-pixel",98,3e,8c,55)) ){
...
HXLINE( 651)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("spooky",eb,bd,9e,c1)) ){
HXLINE( 662)				this->danced = !(this->danced);
HXLINE( 664)				if (this->danced) {
HXLINE( 665)					this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            				}
            				else {
HXLINE( 667)					this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            				}
HXLINE( 661)				goto _hx_goto_21;
            			}
            			/* default */{
HXLINE( 669)				this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
            			}
            			_hx_goto_21:;
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_675_playAnim)
HXLINE( 676)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 678)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 679)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 681)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 684)			this->offset->set(0,0);
            		}
HXLINE( 686)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 688)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 690)				this->danced = true;
            			}
            			else {
HXLINE( 692)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 694)					this->danced = false;
            				}
            			}
HXLINE( 697)			bool _hx_tmp;
HXDLIN( 697)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 697)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_706_addOffset)
HXDLIN( 706)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 706)		this->animOffsets->set(name,v);
            	}
