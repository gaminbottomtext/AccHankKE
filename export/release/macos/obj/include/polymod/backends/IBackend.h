...
class HXCPP_CLASS_ATTRIBUTES IBackend_obj {
	public:
		...
		void (::hx::Object :: *_hx_init)( ::Dynamic params); 
		static inline void init( ::Dynamic _hx_, ::Dynamic params) {
			(_hx_.mPtr->*( ::hx::interface_cast< ::polymod::backends::IBackend_obj *>(_hx_.mPtr->_hx_getInterface(0x4ed455e0)))->_hx_init)(params);
		}
